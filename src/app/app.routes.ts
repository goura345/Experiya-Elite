...
import { SERVICE_PROVIDER_ROUTES } from "./service-providers/service-provder.routes";
...
const serviceProviderRoutes = () => import('./service-providers/service-provder.routes').then(x => x.SERVICE_PROVIDER_ROUTES)
...
export const APP_ROUTES: Routes = [
    ...
    { path: 'service-providers', loadChildren: serviceProviderRoutes, canActivate: [authGuard] },
